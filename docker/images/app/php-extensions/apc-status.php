...
$infoOpcode = @apcu_cache_info('opcode', true);
$infoUser = @apcu_cache_info('user', true);
$infoAlloc = @apcu_sma_info(true);
...
$used_mem_percentage = $used_mem_size / $total_mem_size * 100;
